package com.example.ipprinterv2.ui.activity.fragment;
...
import com.example.ipprinterv2.services.PrintUtility;
import com.example.ipprinterv2.services.WifiScanner;
import com.example.ipprinterv2.ui.activity.PrintFragmentActivity;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mBtnDownloadAndPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mPrintDialog.show();
                mObservable.attach((java.util.Observer) PrintFragment.this);
