...
import com.example.ipprinterv2.PrintServicesAdapter;
import com.example.ipprinterv2.R;
import com.example.ipprinterv2.Util;
import com.example.ipprinterv2.ui.activity.WifiListActivity;
...
public class PrintUtility implements Observer {
    ...
    private List<android.print.PrintJob> mPrintJobs;
    ...
    public PrintUtility(Activity mActivity, WifiManager mWifiManager, WifiScanner mWifiScanner) {
        ...
        mObservable = (Observable) ObservableSingleton.getInstance();
                ...
                public void run() {
                    ...
                    if (mPrinterConfiguration.status == WifiConfiguration.Status.CURRENT) {
                        if (mWifiManager.getConnectionInfo().getSupplicantState() == SupplicantState.COMPLETED) {
                            ...
                            if (/*Util.computePDFPageCount(pdfFile)*/ 1> 0) {
